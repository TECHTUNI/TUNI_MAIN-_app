...
//   final List<ProductCategory> _providerhalfsleve = [];
//   final List<ProductCategory> _Allproducts = [];
//   final List<ProductCategory> _typewise = [];
...
//   final List<ProductCategory> _Allproducts = [];
//   final List<ProductCategory> _typewise = [];
//   final List<ComboDetailPage> _comboproducts = [];
...
//   List<ProductCategory> get Allproducts => _Allproducts;
//   List<ProductCategory> get typewise => _typewise;
//   List<ComboDetailPage> get comboproducts => _comboproducts;
...
//   Future<void> getcomboproducts() async {
//     try {
//       List<ComboDetailPage> comboProducts =
//           await productRepo.fetchComboProducts();

//       _comboproducts.clear();

//       // Assuming combo products have unique IDs
//       Set<String> uniqueProductIds = {};

//       for (ComboDetailPage product in comboProducts) {
//         if (!uniqueProductIds.contains(product.comboId)) {
//           _comboproducts.add(product);
//           uniqueProductIds.add(product.comboId);
//         }
//       }
...
//       notifyListeners();
//     } catch (error) {
//       print('Error fetching combo products: $error');
//     }
//   }
...
//agian new product_provider(10th july)
