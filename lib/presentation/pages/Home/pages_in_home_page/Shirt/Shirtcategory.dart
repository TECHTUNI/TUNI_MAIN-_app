...
class ProductsShirtInExplore extends StatefulWidget {
  ...
  ProductsShirtInExplore({super.key, required this.productList});
...
class ProductsCategoryInExploreState extends State<ProductsShirtInExplore> {
